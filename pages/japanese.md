...
Represented here are the authors who have written works in Japanese. Some of these may be texts translated into Japanese from other languages.
...
<div class="col-sm-10">
<div class="page_title"><h3>Japanese</h3></div>
...
<script>
		...
		function showCategory (filter = "") {
			$('#data-container').html('');
			filter = filter.trim();
			$.getJSON("{{ site.baseurl }}/data/japanese.json", function (data) {
				let cards = [];
