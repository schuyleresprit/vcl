...
<div class="col-sm-10">
<div class="page_title"><h3>Spanish</h3></div>

Represented here are the authors who have written works in Spanish. Some of these may be texts translated into Spanish from other languages.
...
<body>
	...
	<script>
		...
		function showCategory (filter = "") {
			$('#data-container').html('');
			filter = filter.trim();
			$.getJSON("{{ site.baseurl }}/data/spanish.json", function (data) {
				let cards = [];
