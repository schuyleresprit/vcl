...
permalink: /Italian/
---
Represented here are the authors who have written works in Italian. Some of these may be texts translated into Italian from other languages.
...
<div class="col-sm-10">
<div class="page_title"><h3>Italian</h3></div>
<html>
<body>
	<div class="container">
...
<script>
		...
		function showCategory (filter = "") {
			$('#data-container').html('');
			filter = filter.trim();
			$.getJSON("{{ site.baseurl }}/data/italian.json", function (data) {
				let cards = [];
