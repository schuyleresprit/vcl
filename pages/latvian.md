...
<div class="col-sm-10">
<div class="page_title"><h3>Latvian</h3></div>

Represented here are the authors who have written works in Latvian. Some of these may be texts translated into Latvian from other languages.
...
<body>
	...
	<script>
		...
		function showCategory (filter = "") {
			$('#data-container').html('');
			filter = filter.trim();
			$.getJSON("{{ site.baseurl }}/data/latvian.json", function (data) {
				let cards = [];
