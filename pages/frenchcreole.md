...
<div class="col-sm-10">
<div class="page_title"><h3> French Creole</h3></div>
Represented here are the authors who have written works in French Creole. Some of these may be texts translated into French Creole from other languages.
	<div class="container">
...
<script>
		...
		function showCategory (filter = "") {
			$('#data-container').html('');
			filter = filter.trim();
			$.getJSON("{{ site.baseurl }}/data/frenchcreole.json", function (data) {
				let cards = [];
