...
<div class="col-sm-10">
<div class="page_title"><h3>Portuguese</h3></div>

Represented here are the authors who have written works in Portuguese. Some of these may be texts translated into Portuguese from other languages.
...
<body>
	...
	<script>
		...
		function showCategory (filter = "") {
			$('#data-container').html('');
			filter = filter.trim();
			$.getJSON("{{ site.baseurl }}/data/portuguese.json", function (data) {
				let cards = [];
