...
Represented here are the authors who have written works in Welsh. Some of these may be texts translated into Welsh from other languages.
...
<div class="col-sm-10">
<div class="page_title"><h3> Welsh</h3></div>
...
<script>
		...
		function showCategory (filter = "") {
			$('#data-container').html('');
			filter = filter.trim();
			$.getJSON("{{ site.baseurl }}/data/welsh.json", function (data) {
				let cards = [];
