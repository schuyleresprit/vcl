...
<div class="col-sm-10">
<div class="page_title"><h3>Swedish</h3></div>

Represented here are the authors who have written works in Swedish. Some of these may be texts translated into Swedish from other languages.
...
<body>
	...
	<script>
		...
		function showCategory (filter = "") {
			$('#data-container').html('');
			filter = filter.trim();
			$.getJSON("{{ site.baseurl }}/data/swedish.json", function (data) {
				let cards = [];
