...
<div class="col-sm-10">
<div class="page_title"><h3>Hebrew</h3></div>
Represented here are the authors who have written works in Hebrew. Some of these may be texts translated into Hebrew from other languages.
	<div class="container">
	...
	<script>
		...
		function showCategory (filter = "") {
			$('#data-container').html('');
			filter = filter.trim();
			$.getJSON("{{ site.baseurl }}/data/hebrew.json", function (data) {
				let cards = [];
