...
<div class="col-sm-10">
<div class="page_title"><h3>Greek, Modern</h3></div>
Represented here are the authors who have written works in Greek, Modern. Some of these may be texts translated into Greek, Modern from other languages.
	<div class="container">
...
<h5>Return to <a href="{% link pages/languages.md %}">Languages</a></h5>
	...
	<script>
		...
		function showCategory (filter = "") {
			$('#data-container').html('');
			filter = filter.trim();
			$.getJSON("{{ site.baseurl }}/data/greekmodern.json", function (data) {
				let cards = [];
