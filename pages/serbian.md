...
Represented here are the authors who have written works in Serbian. Some of these may be texts translated into Serbian from other languages.
...
<div class="col-sm-10">
<div class="page_title"><h3>Serbian</h3></div>
...
<script>
		...
		function showCategory (filter = "") {
			$('#data-container').html('');
			filter = filter.trim();
			$.getJSON("{{ site.baseurl }}/data/serbian.json", function (data) {
				let cards = [];
