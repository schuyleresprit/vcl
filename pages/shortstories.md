...
<div class="col-sm-10">
<div class="page_title"><h3> Short Story</h3></div>

Represented here are the authors who have written works in Short Story. Some of these may be texts translated into Short Story from other languages.
...
<body>
	...
	<script>
		let datasets = [
			{
				"type" : "fictionstory",
				"url" : "{{ site.baseurl }}/data/fictionstory.json"
			}
		];
		var dataLinks = [];
