...
<div class="col-sm-10">
<div class="page_title"><h3>Norwegian</h3></div>

Represented here are the authors who have written works in Norwegian. Some of these may be texts translated into Norwegian from other languages.
...
<body>
	...
	<script>
		...
		function showCategory (filter = "") {
			$('#data-container').html('');
			filter = filter.trim();
			$.getJSON("{{ site.baseurl }}/data/norwegian.json", function (data) {
				let cards = [];
