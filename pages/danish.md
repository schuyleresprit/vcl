...
<div class="col-sm-10">
<div class="page_title"><h3>Danish</h3></div>

Represented here are the authors who have written works in Danish. Some of these may be texts translated into Danish from other languages.
...
<body>
	...
	<script>
		...
		function showCategory (filter = "") {
			$('#data-container').html('');
			filter = filter.trim();
			$.getJSON("{{ site.baseurl }}/data/danish.json", function (data) {
				let cards = [];
