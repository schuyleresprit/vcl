 ...
 <div id="post-15" class="vesti-col timeline-post">
  ...
  <div id="post-16" class="vesti-col timeline-post">
   ...
   <div class="vesti-content-wrapper">
     ...
     <div class="vesti-desc">
       <a class="desc-a" href="#">
         <h4><a href="{{ site.baseurl }}/lgcarriles/">Lázaro Gómez Carriles</a></h4>
       </a>
     </div>
   </div>
 </div>
<div id="post-21" class="vesti-col timeline-post">
     ...
     <div id="post-25" class="vesti-col timeline-post">
      <div class="vesti-content-wrapper">
        ...
        <div class="vesti-desc">
          <a class="desc-a" href="https://es.wikipedia.org/wiki/Mariano_Rodr%C3%ADguez">
            <h4><a href="{{ site.baseurl }}/mrodriguez/">Mariano Rodríguez</a></h4>
          </a>
        </div>
      </div>
    </div>
     <div id="post-26" class="vesti-col timeline-post">
      <div class="vesti-content-wrapper">
        ...
        <div class="vesti-desc">
          <a class="desc-a" href="#">
            <h4><a href="{{ site.baseurl }}/mbleon/">Marilyn Bobes León</a></h4>
          </a>
        </div>
      </div>
    </div>
...
<div id="post-30" class="vesti-col timeline-post">
      <div class="vesti-content-wrapper">
        <div class="photo">
          <img src="https://encrypted-tbn1.gstatic.com/images?q=tbn:ANd9GcSA3mMJNy7IhoBW8pBrZohfDpWDO00ywSfcK864vxKlv2wt7UjF" width="60%">
          <div class="vesti-date-wrapper">
            <div class="vesti-date">
            </div>
          </div>
    ...
    <div id="post-31" class="vesti-col timeline-post">
      <div class="vesti-content-wrapper">
        ...
        <div class="vesti-desc">
          <a class="desc-a" href="#">
            <h4><a href="{{ site.baseurl }}/ngullien/">Nicolás Guillén</a></h4>
          </a>
        </div>
      </div>
    </div>
