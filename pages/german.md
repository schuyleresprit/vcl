...
Represented here are the authors who have written works in German. Some of these may be texts translated into German from other languages.
...
<div class="col-sm-10">
<div class="page_title"><h3>German</h3></div>
<html>
<body>
	<div class="container">
...
<script>
		...
		function showCategory (filter = "") {
			$('#data-container').html('');
			filter = filter.trim();
			$.getJSON("{{ site.baseurl }}/data/german.json", function (data) {
				let cards = [];
