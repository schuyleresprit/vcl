...
Represented here are the authors who have written works in Romanian. Some of these may be texts translated into Romanian from other languages.
...
<div class="col-sm-10">
<div class="page_title"><h3> Romanian</h3></div>
...
<script>
		...
		function showCategory (filter = "") {
			$('#data-container').html('');
			filter = filter.trim();
			$.getJSON("{{ site.baseurl }}/data/romanian.json", function (data) {
				let cards = [];
