    ...
    <head>
        ...
        <title>Author Details - acwinkler</title>
    </head>
    <body>
        <h1>Author Details - acwinkler</h1>
        
            <ul>
                <li><strong>Title:</strong> Dog War</li>
            ...
            <ul>
                <li><strong>Title:</strong> God Carlos</li>
                <li><strong>Genre:</strong> Fiction (Novel)</li>
                <li><strong>Language:</strong> English</li>
                <li><strong>Publisher:</strong> Akashic Books</li>
                <li><strong>Publication City:</strong> brooklyn_ny_united states</li>
            ...
            <ul>
                <li><strong>Title:</strong> The Family Mansion</li>
                <li><strong>Genre:</strong> Fiction (Novel)</li>
                <li><strong>Language:</strong> English</li>
                <li><strong>Publisher:</strong> Akashic Books</li>
                <li><strong>Publication City:</strong> brooklyn_ny_united states</li>
            ...
            <ul>
                <li><strong>Title:</strong> The Lunatic</li>
                <li><strong>Genre:</strong> Fiction (Novel)</li>
                <li><strong>Language:</strong> English</li>
                <li><strong>Publisher:</strong> Akashic Books</li>
                <li><strong>Publication City:</strong> brooklyn_ny_united states</li>
            ...
            <ul>
                <li><strong>Title:</strong> Going Home To Teach</li>
